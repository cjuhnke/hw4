...
export default class App extends React.Component {
  ...
  async getWeather() {
    ...
    this.setState({
      ...
      forecast: response.weather.daily.data.splice(0,forecastDays)
    });
  }
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.currentWeather}>
          <Text style={styles.currentIcon}>{this.state.currentIcon && (<Icon size={100} color="#000" name={icon(this.state.currentIcon)} />)}</Text>
